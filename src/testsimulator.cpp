...
STATE *TEST_SIMULATOR::CreateStartState() const { return new TEST_STATE; }

void TEST_SIMULATOR::FreeState(STATE *state) const { delete state; }

bool TEST_SIMULATOR::Step(STATE &state, int action, int &observation,
                          double &reward) const {
