...
set output 'rooms_16_Simulations_DiscountedReturn.tex'
set xlabel 'Simulations' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-18963.txt' u 1:5:6 w yerrorlines t 'MCTS', 'output-18964.txt' u 1:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-18965.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-18966.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 