...
plot'output-18967.txt' u 1:5:6 w yerrorlines t 'MCTS', 'output-18968.txt' u 1:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-18969.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-18970.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 