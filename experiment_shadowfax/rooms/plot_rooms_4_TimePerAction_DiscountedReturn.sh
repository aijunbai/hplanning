...
set output 'rooms_4_TimePerAction_DiscountedReturn.tex'
set xlabel 'Time Per Action (s)' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-16583.txt' u 8:5:6 w yerrorlines t 'MCTS', 'output-16584.txt' u 8:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-16585.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-16586.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 