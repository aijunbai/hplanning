...
set output 'continousrooms_32_Simulations_DiscountedReturn.tex'
set xlabel 'Simulations' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-13993.txt' u 1:5:6 w yerrorlines t 'MCTS', 'output-13994.txt' u 1:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-13995.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-13996.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 