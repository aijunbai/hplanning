...
set output 'continousrooms_16_TimePerAction_DiscountedReturn.tex'
set xlabel 'Time Per Action (s)' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-16317.txt' u 8:5:6 w yerrorlines t 'MCTS', 'output-16318.txt' u 8:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-16319.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-16320.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 