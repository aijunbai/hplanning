...
set output 'continousrooms_4_Simulations_DiscountedReturn.tex'
set xlabel 'Simulations' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-18816.txt' u 1:5:6 w yerrorlines t 'MCTS', 'output-18817.txt' u 1:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-18818.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-18819.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 