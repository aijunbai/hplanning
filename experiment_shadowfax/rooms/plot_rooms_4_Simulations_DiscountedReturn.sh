...
set output 'rooms_4_Simulations_DiscountedReturn.tex'
set xlabel 'Simulations' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-18955.txt' u 1:5:6 w yerrorlines t 'MCTS', 'output-18956.txt' u 1:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-18957.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-18958.txt' u 1:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 