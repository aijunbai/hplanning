...
set output 'TimePerAction_.tex'
set xlabel 'TimePerAction' font 'DejaVuSansCondensed,18'
set ylabel '' font 'DejaVuSansCondensed,18'
plot'output-7623.txt' u 8:11:12 w yerrorlines t 'P:rooms0;M:1;AS:0', 'output-7624.txt' u 8:11:12 w yerrorlines t 'P:rooms10;M:-1;AS:0', 'output-7625.txt' u 8:11:12 w yerrorlines t 'P:rooms10;M:1;AS:0', 'output-7626.txt' u 8:11:12 w yerrorlines t 'P:rooms11;M:-1;AS:0', 'output-7627.txt' u 8:11:12 w yerrorlines t 'P:rooms11;M:1;AS:0', 'output-7628.txt' u 8:11:12 w yerrorlines t 'P:rooms11;M:-1;AS:1', 'output-7629.txt' u 8:11:12 w yerrorlines t 'P:rooms11;M:1;AS:1', 