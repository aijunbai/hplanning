...
set output 'continousrooms_8_TimePerAction_DiscountedReturn.tex'
set xlabel 'Time Per Action (s)' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-16312.txt' u 8:5:6 w yerrorlines t 'MCTS', 'output-16313.txt' u 8:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-16314.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-16315.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 