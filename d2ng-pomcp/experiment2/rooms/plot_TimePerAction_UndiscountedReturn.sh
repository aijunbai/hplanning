...
set output 'TimePerAction_UndiscountedReturn.tex'
set xlabel 'TimePerAction' font 'DejaVuSansCondensed,18'
set ylabel 'UndiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-28791.txt' u 8:3:4 w yerrorlines t 'rooms0:10', 'output-28792.txt' u 8:3:4 w yerrorlines t 'rooms10:10', 'output-28793.txt' u 8:3:4 w yerrorlines t 'rooms11:10', 'output-28794.txt' u 8:3:4 w yerrorlines t 'rooms11:10:polling', 'output-28795.txt' u 8:3:4 w yerrorlines t 'rooms11:10:stack', 'output-28796.txt' u 8:3:4 w yerrorlines t 'rooms11:10:polling:stack', 