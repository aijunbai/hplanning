...
set output 'rooms_16_TimePerAction_DiscountedReturn.tex'
set xlabel 'Time Per Action (s)' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-16591.txt' u 8:5:6 w yerrorlines t 'MCTS', 'output-16592.txt' u 8:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-16593.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-16594.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 