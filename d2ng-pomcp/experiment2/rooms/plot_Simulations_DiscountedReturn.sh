...
set output 'Simulations_DiscountedReturn.tex'
set xlabel 'Simulations' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-15953.txt' u 1:5:6 w yerrorlines t 'rooms0', 'output-15954.txt' u 1:5:6 w yerrorlines t 'rooms10', 'output-15955.txt' u 1:5:6 w yerrorlines t 'rooms11', 