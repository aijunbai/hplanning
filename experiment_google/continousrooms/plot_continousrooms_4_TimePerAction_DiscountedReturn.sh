...
set output 'continousrooms_4_TimePerAction_DiscountedReturn.tex'
set xlabel 'Time Per Action (s)' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-16308.txt' u 8:5:6 w yerrorlines t 'MCTS', 'output-16309.txt' u 8:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-16310.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-16311.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 