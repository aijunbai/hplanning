...
set output 'Simulations_UndiscountedReturn.tex'
set xlabel 'Simulations' font 'DejaVuSansCondensed,18'
set ylabel 'UndiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-28785.txt' u 1:3:4 w yerrorlines t 'rooms0:8', 'output-28786.txt' u 1:3:4 w yerrorlines t 'rooms10:8', 'output-28787.txt' u 1:3:4 w yerrorlines t 'rooms11:8', 'output-28788.txt' u 1:3:4 w yerrorlines t 'rooms11:8:polling', 'output-28789.txt' u 1:3:4 w yerrorlines t 'rooms11:8:stack', 'output-28790.txt' u 1:3:4 w yerrorlines t 'rooms11:8:polling:stack', 