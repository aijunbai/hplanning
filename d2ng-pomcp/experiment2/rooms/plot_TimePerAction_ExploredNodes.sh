...
set output 'TimePerAction_ExploredNodes.tex'
set xlabel 'TimePerAction' font 'DejaVuSansCondensed,18'
set ylabel 'ExploredNodes' font 'DejaVuSansCondensed,18'
plot'output-28785.txt' u 8:9:10 w yerrorlines t 'rooms0:8', 'output-28786.txt' u 8:9:10 w yerrorlines t 'rooms10:8', 'output-28787.txt' u 8:9:10 w yerrorlines t 'rooms11:8', 'output-28788.txt' u 8:9:10 w yerrorlines t 'rooms11:8:polling', 'output-28789.txt' u 8:9:10 w yerrorlines t 'rooms11:8:stack', 'output-28790.txt' u 8:9:10 w yerrorlines t 'rooms11:8:polling:stack', 