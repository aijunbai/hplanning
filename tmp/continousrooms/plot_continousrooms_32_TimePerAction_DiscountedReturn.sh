...
set output 'continousrooms_32_TimePerAction_DiscountedReturn.tex'
set xlabel 'Time Per Action (s)' font 'DejaVuSansCondensed,18'
set ylabel 'DiscountedReturn' font 'DejaVuSansCondensed,18'
plot'output-16321.txt' u 8:5:6 w yerrorlines t 'MCTS', 'output-16322.txt' u 8:5:6 w yerrorlines t 'MCTS$|_\phi$', 'output-16323.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:polling', 'output-16324.txt' u 8:5:6 w yerrorlines t 'MCTS$|_{\phi,\mathcal{O}}$:smart:polling', 